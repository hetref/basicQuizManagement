const questions = [
    ...
    { question: "Effects of air pollution on the environment include:", options: ["Global warming", "Acid rain", "Greenhouse effect", "All of the above"], correctAnswer: 3 },
    { question: "The particulate matter suspended in air includes:", options: ["Dust", "Pollen", "Liquid droplets", "All of the above"], correctAnswer: 3 },
    ...
    { question: "Green belt development benefited in:", options: ["Reducing air pollution", "Water conservation", "Reduce soil erosion", "All of the above"], correctAnswer: 3 },
    ...
    { question: "The responsibilities of the pollution control board include:", options: ["Create public awareness", "Inspect sewage", "Inspect air control systems", "All of the above"], correctAnswer: 3 },
    ...
    { question: "Watershed within crop fields is called as:", options: ["Micro watershed", "Small watershed", "Large watershed", "All of the above"], correctAnswer: 0 },
    ...
    { question: "Sustainable Development includes:", options: ["Economical development", "Generate resources", "Maintain balance between human and environment"], correctAnswer: 2 },
